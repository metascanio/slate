...
If an error occurs using the text query, the data returned will contain an error prefix, followed by an error message and a specific error-code.
...
WebScore | Score between 0.1 to 1.0 for Web/application abuse.
